...
void asus_fixup_mtdparts(void *fdt)
{
	static const struct node_info nodes[] = {
		{ "spi-nand", MTD_DEV_TYPE_SPINAND}, // match to dts 'compatible = "spi-nand";'
	};

#if defined(CONFIG_BOOT_MTDPARTS_DEFAULT)
	env_set("mtdparts", CONFIG_BOOT_MTDPARTS_DEFAULT);
#endif
